...
var Game = (function() {
  ...
  canvas[0] = document.getElementById('grid1');
  canvas[1] = document.getElementById('grid2');
  ...
  function setTurn(turnState) {
    if(gameStatus !== GameStatus.gameOver) {
      ...
      if(turn) {
        $('#turn-status').removeClass('alert-opponent-turn').addClass('alert-your-turn').html('A votre tour');
      } else {
        $('#turn-status').removeClass('alert-your-turn').addClass('alert-opponent-turn').html('Tour de l\'adversaire');
      }
    }
  };
  ...
  function setGameOver(isWinner) {
    ...
    if(isWinner) {
      $('#turn-status').removeClass('alert-opponent-turn').removeClass('alert-your-turn')
              .addClass('alert-winner').html('Gagné <a href="#" class="btn-leave-game">Rejouer</a>.');
    } else {
      $('#turn-status').removeClass('alert-opponent-turn').removeClass('alert-your-turn')
              .addClass('alert-loser').html('Perdu <a href="#" class="btn-leave-game">Rejouer</a>.');
    }
